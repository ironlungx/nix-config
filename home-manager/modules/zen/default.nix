...
let
  cfg = config.myhm.zen-browser;
in
{
  options.myhm.zen-browser.enable = lib.mkEnableOption "zen-browser";

  imports = [ inputs.zen-browser.homeModules.default ];

  # Zen and Stylix DO NOT mix well...
  config.stylix.targets.zen-browser.enable = false;
    ...
    profiles.ironlung = {
      ...
      settings = {
        ...
        "browser.uiCustomization.state" = ''
          {"placements":{"widget-overflow-fixed-list":[],"unified-extensions-area":["sponsorblocker_ajay_app-browser-action","addon_darkreader_org-browser-action","jid1-kkzogwgsw3ao4q_jetpack-browser-action","_34daeb50-c2d2-4f14-886a-7160b24d66a4_-browser-action","_7a7a4a92-a2a0-41d1-9fd7-1e92480d612d_-browser-action","desmodder_jared-hughes_github_io-browser-action","engineerbaba049_gmail_com-browser-action","idcac-pub_guus_ninja-browser-action","_762f9885-5a13-4abd-9c77-433dcd38b8fd_-browser-action"],"nav-bar":["back-button","forward-button","vertical-spacer","urlbar-container","_d7742d87-e61d-4b78-b8a1-b469842139fa_-browser-action","ublock0_raymondhill_net-browser-action","unified-extensions-button","myallychou_gmail_com-browser-action","leechblockng_proginosko_com-browser-action"],"toolbar-menubar":["menubar-items"],"TabsToolbar":["tabbrowser-tabs"],"vertical-tabs":[],"PersonalToolbar":["import-button","personal-bookmarks"],"zen-sidebar-top-buttons":[],"zen-sidebar-foot-buttons":["downloads-button","zen-workspaces-button","zen-create-new-button"]},"seen":["_d7742d87-e61d-4b78-b8a1-b469842139fa_-browser-action","addon_darkreader_org-browser-action","jid1-kkzogwgsw3ao4q_jetpack-browser-action","_34daeb50-c2d2-4f14-886a-7160b24d66a4_-browser-action","ublock0_raymondhill_net-browser-action","sponsorblocker_ajay_app-browser-action","_7a7a4a92-a2a0-41d1-9fd7-1e92480d612d_-browser-action","developer-button","screenshot-button","myallychou_gmail_com-browser-action","desmodder_jared-hughes_github_io-browser-action","engineerbaba049_gmail_com-browser-action","idcac-pub_guus_ninja-browser-action","leechblockng_proginosko_com-browser-action","_762f9885-5a13-4abd-9c77-433dcd38b8fd_-browser-action"],"dirtyAreaCache":["unified-extensions-area","nav-bar","vertical-tabs","zen-sidebar-foot-buttons","PersonalToolbar","zen-sidebar-top-buttons","toolbar-menubar","TabsToolbar"],"currentVersion":23,"newElementCount":7}
        '';
      };
      search.force = true;
      search.engines = {
